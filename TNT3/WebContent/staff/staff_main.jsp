		...
		<div class="container">
			<div class="row">
				<div class="col-xl-9 mx-auto">
					<h1 class="mb-5">
						<a href="<%=request.getContextPath()%>/staff/staff_main.jsp" style="color:white">Tuter
							& Tutee</a>
					</h1>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
						...
						<h3>
							<a
								href="<%=request.getContextPath()%>/Staff_login/staff_control.jsp?action=absence">Absence</a>
						</h3>
					</div>
				</div>
			</div>
