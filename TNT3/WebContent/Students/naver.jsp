...
<head>
	...
	<link rel="stylesheet" href="https://nid.naver.com/inc/user/css/V2Join.css?20180508">
	<script type="text/javascript" src="clickcr.js"></script>
	<script type="text/javascript" src="lcs_nclicks.js"></script>
...
<form id="join_form" method="post" action="/user2/V2Join.nhn?m=end">
    <input type="hidden" id="token_sjoin" name="token_sjoin" value="1bYCb1ZJzg2nIPD4">
                ...
                <div class="row_group">
                    ...
                    <div class="join_row join_email">
                        ...
                        <span class="ps_box int_email box_right_space">
							<input type="text" id="email" name="email" maxlength="100" placeholder="선택입력" aria-label="선택입력" class="int" maxlength="100">
						</span>
                    </div>
                ...
                <div class="join_minor tab" id="pmobDiv" style="display:none">
                    ...
                    <div id="wa_tab_phone" role="tabpanel">
                        <div class="agree_check_wrap">
                            ...
                            <span class="error_next_box" id="pagreeMsg" style="display:none" role="alert">필수 정보입니다.</span>
                        </div>
                        <div class="row_group">
                            <div class="join_row">
                                ...
                                <span class="error_next_box" id="pnameMsg" style="display:none" role="alert">필수 정보입니다.</span>
                            </div>
                            <div class="join_row join_birthday">
                                ...
                                <span class="error_next_box" id="pbirthdayMsg" style="display:none" role="alert">필수 정보입니다.</span>
                            </div>
                            <div class="join_row">
                                ...
                                <span class="error_next_box" id="pgenderMsg" style="display:none" role="alert"></span>
                            </div>
                        </div>
                        ...
                        <div class="join_row join_mobile">
                            ...
                            <span class="error_next_box" id="pphoneNoMsg" style="display:none" role="alert">필수 정보입니다.</span>
                            <span class="error_next_box" id="pauthNoMsg" style="display:none" role="alert">필수 정보입니다.</span>
                            <span class="error_next_box" id="pjoinMsg" style="display:none" role="alert">필수 정보입니다.</span>
                        </div>
                    </div>
                </div>
                <!-- tg-display -->
                ...
                <div class="join_minor tab" id="pipinDiv" style="display:none">
                    ...
                    <div id="wa_tab_ipin" role="tabpanel">
                        <div class="terms_chk_all">
                            ...
                            <span class="error_next_box" id="iagreeMsg" style="display:none" role="alert">필수 정보입니다.</span>
                        </div>
                        <div class="ipin_box">
                            ...
                            <span class="error_next_box" id="ipopupMsg" style="display:none" role="alert">필수 정보입니다.</span>
                        </div>
                        <div class="join_row join_mobile">
                            ...
                            <span class="error_next_box" id="iphoneNoMsg" style="display:none" role="alert">필수 정보입니다.</span>
...
<form name="form_ipin" method="post" action="">
    ...
    <input type="hidden" name="enc_data" value="">
</form>

<script type="text/javascript" src="https://nid.naver.com/inc/common/js/rsaAll.js"></script>
<script type="text/javascript" src="https://nid.naver.com/inc/common/js/lua.js"></script>
<script type="text/javascript" src="https://nid.naver.com/inc/common/js/jquery.min.js"></script>
<script type="text/javascript" src="https://nid.naver.com/inc/common/js/bvsd.1.3.4.js"></script>
<script type="text/JavaScript">
    ...
    function checkId(event) {
        ...
        $.ajax({
            type:"GET",
            url: "https://nid.naver.com/user2/joinAjax.nhn?m=checkId&id=" + id ,
    ...
    function createRsaKey() {
        var rsa = new RSAKey();
        var sessionKey = "T6UPaXbcRdG0Nt11";
        var keyName = "100014063";
        var eValue = "";
        var nValue = "010001";
